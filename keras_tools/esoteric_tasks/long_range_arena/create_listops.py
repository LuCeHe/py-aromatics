...
def main(argv):
    ...
    write_to_file(train, os.path.join(FLAGS.output_dir, '{}_train'.format(FLAGS.task)))
    write_to_file(val, os.path.join(FLAGS.output_dir, '{}_val'.format(FLAGS.task)))
    write_to_file(test, os.path.join(FLAGS.output_dir, '{}_test'.format(FLAGS.task)))
