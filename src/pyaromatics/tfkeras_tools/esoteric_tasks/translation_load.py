...
from ndatasets.arrow_dataset import Dataset
from ndatasets.builder import DatasetBuilder
from ndatasets.dataset_dict import DatasetDict
from ndatasets.features import Features
from ndatasets.info import DATASET_INFOS_DICT_FILE_NAME
from ndatasets.metric import Metric
from ndatasets.splits import Split
from ndatasets.utils.download_manager import GenerateMode
from ndatasets.utils.file_utils import HF_MODULES_CACHE, DownloadConfig, cached_path, head_hf_s3, hf_bucket_url, hf_github_url
from ndatasets.utils.filelock import FileLock
from ndatasets.utils.logging import get_logger
from ndatasets.utils.version import Version
...
def prepare_module(
    ...
    **download_kwargs,
    ...
    # print('os.path.isfile(combined_path): ', os.path.isfile(combined_path))
    ...
    # print('hash:        ', hash)
    module_path = 'datasets_modules.datasets.wmt14.ca938155c590b37f9cb39cef1b11ee1a4f770c90a5a66485f8ecd19b556d58c6.wmt14'
    hash = 'ca938155c590b37f9cb39cef1b11ee1a4f770c90a5a66485f8ecd19b556d58c6'
