# version of the architecture proposed in
# https://arxiv.org/abs/1905.10437
# found here
# https://www.kaggle.com/yamqwe/time-series-modeling-n-beats/notebook
...
def get_model(backcast_length, forecast_length, input_dim):
    model = NBeatsNet(
        backcast_length=backcast_length, forecast_length=forecast_length, input_dim=input_dim,
